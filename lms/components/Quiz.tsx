...
const Quiz: React.FC<QuizProps> = ({ title, questions, subject, unitId, moduleId, moduleName, isLocked = false, onQuizComplete }) => {
        ...
        <div className="quiz-card-wrapper" ref={quizRef}>
            <div className="quiz-card">
                ...
                <div className="quiz-card-right">
                    ...
                    <p style={{ marginBottom: '16px', color: '#616161', fontSize: '0.9rem' }}>
